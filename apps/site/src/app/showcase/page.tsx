...
import { ArrowLeft, ArrowUp, Paperclip, Plus, Copy, Check } from "lucide-react";
import {
  useToolExecutor,
  useEmbeddings,
  useFileUpload,
...
const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
  ...
  const markdownComponents = useMarkdownComponents(handleActionPrompt);
...
function useMarkdownComponents(onActionSelect: (prompt: string) => void) {
  return useMemo(
    () => ({
      code({
        inline,
